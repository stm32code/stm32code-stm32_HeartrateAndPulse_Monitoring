...
//    private static int traceCount = 0;
    ...
    FireworksCircleGraphics(Context context) {
        ...
        endColor = getColor(context, R.color.transparent);
        startColor = getColor(context, R.color.white);
...
//        starPaint.setAntiAlias(true);
    ...
    void draw(Canvas canvas) {
        ...
        if (needRefresh) {
            circleX = (int) (width * SportsView.START_CIRCLE_X_SCALE);
            circleY = (int) (height * SportsView.START_CIRCLE_Y_SCALE);
